...
export default class UserCrud extends Component {
    ...
    renderRows() {
        return this.state.list.map(user => {
            return (
                <tr key={user.id}>
                    <td className="text-nowrap text-truncate">{user.id}</td>
                    <td className="text-nowrap text-truncate">{user.name}</td>
                    <td className="text-nowrap text-truncate">{user.email}</td>
